...
hold on;
plot(outA.t, outA.cell__x__m, 'Color', myColors.blue, 'LineWidth', lineWidth);
plot(outB.t, outB.cell__x__m, '--', 'Color', myColors.blue, 'LineWidth', lineWidth);
plot(outC.t, outC.cell__x__m, 'Color', myColors.orange, 'LineWidth', lineWidth);
plot(outD.t, outD.cell__x__m, '--', 'Color', myColors.orange, 'LineWidth', lineWidth);
...
hold on;
plot(outA.t, outA.cell__mu, 'Color', myColors.blue, 'LineWidth', lineWidth-0.3);
plot(outB.t, outB.cell__mu, '--', 'Color', myColors.blue, 'LineWidth', lineWidth+0.3);
plot(outC.t, outC.cell__mu, 'Color', myColors.orange, 'LineWidth', lineWidth);
plot(outD.t, outD.cell__mu, '--', 'Color', myColors.orange, 'LineWidth', lineWidth);
