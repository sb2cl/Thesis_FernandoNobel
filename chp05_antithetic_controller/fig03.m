...
colors_{2} = myColors.orange;

fig = figure('units','centimeters','position',[0,0,13.5,9]);
...
leg = legend('base substrate', 'low substrate', 'Location', 'southeast','interpreter','latex');
...
print(fig,'./figs/fig03.eps','-depsc');
end